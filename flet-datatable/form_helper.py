...
class FormHelper(UserControl):
    ...
    # when we update, it works, but we need to set the read only back to True after we leave the text field
    ...
    def build(self):
        return TextField(
            ...
            color="black",
            # important changes
            read_only=True,  # we need to make it true so user can't change it
